...
namespace CarDetector.iOS
{
    ...
    {
        public void Include(UITableViewCell cell)
        {
        ...
        public void Include(BaseViewModel viewModel)
        {
            viewModel = new BaseViewModel();
        }

        public void Include(MainViewModel viewModel)
        {
            viewModel = new MainViewModel();
        }

        public void Include(ResultViewModel viewModel)
        {
            viewModel = new ResultViewModel();
        }

        public void Include(CameraService service)
        {
